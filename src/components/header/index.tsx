            ...
            <div className={classes.box}>
                <div className={classes.block}>
                    <div className={classes.title}>
                        ...
                        <Link to={generatePath("")}>
                            <div className={classes.showroom}>Showroom</div>
                        </Link>
                    ...
                    <div className={classes.secondPart}>
                        <div className={classes.name}>
                            <Link to={generatePath("")}>
                                <div className={classes.login}>Dealer Login</div>
                            </Link>
                            <Link to={generatePath("")}>
                                <div className={classes.dealer}>Become A Dealer</div>
                            </Link>
                            <Link to={generatePath("")}>
                                <div className={classes.retail}>Find A Retail</div>
                            </Link>
