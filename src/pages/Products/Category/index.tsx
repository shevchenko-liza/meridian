        ...
        <div className={classes.box}>
            <div className={classes.block}>
                ...
                <div className={classes.roomBox}>
                    <button className={classes.livingRoom}>Living Room</button>
                    <svg className={classes.roomPlus} width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
