...
export const Item: React.FC<ItemProps> = ({ id, name, price, photo, discount, promotional_price }) => (
    <div>
        <img className={classes.photo} src={photo} alt="" />
        <Link to={generatePath(":name/:id", { id,name })} className={classes.name}>{name} </Link>
        <div>
